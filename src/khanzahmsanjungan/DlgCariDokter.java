        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeDokter\":\"" + rs.getString(1) + "\",\"NamaDokter\":\"" + rs.getString(2).replaceAll("\"", "") + "\",\"JK\":\"" + rs.getString(3) + "\",\"TmpLahir\":\"" + rs.getString(4).replaceAll("\"", "") + "\",\"TglLahir\":\"*****\",\"GD\":\"" + rs.getString(6) + "\",\"Agama\":\"" + rs.getString(7) + "\",\"AlamatTinggal\":\"" + rs.getString(8).replaceAll("\"", "") + "\",\"NoTelp\":\"************\",\"SttsNikah\":\"*****\",\"Spesialis\":\"" + rs.getString(11) + "\",\"Alumni\":\"" + rs.getString(12).replaceAll("\"", "") + "\",\"NoIjinPraktek\":\"" + rs.getString(13) + "\"},";
                }
            } catch (Exception e) {
