...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        jLabel9.setBounds(430, 100, 90, 23);

        NmDokter.setEditable(false);
        NmDokter.setHighlighter(null);
        NmDokter.setName("NmDokter"); // NOI18N
        FormInput.add(NmDokter);
        NmDokter.setBounds(610, 100, 160, 23);

        NoSEP.setEditable(false);
        NoSEP.setHighlighter(null);
        NoSEP.setName("NoSEP"); // NOI18N
        FormInput.add(NoSEP);
        NoSEP.setBounds(286, 10, 220, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        BtnDokter.setBounds(770, 100, 120, 23);

        jLabel11.setText("Unit/Poli :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(30, 100, 60, 23);

        KdPoli.setEditable(false);
        KdPoli.setHighlighter(null);
        KdPoli.setName("KdPoli"); // NOI18N
        FormInput.add(KdPoli);
        KdPoli.setBounds(90, 100, 70, 23);

        NmPoli.setEditable(false);
        NmPoli.setHighlighter(null);
        NmPoli.setName("NmPoli"); // NOI18N
        NmPoli.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NmPoliActionPerformed(evt);
            }
        });
        FormInput.add(NmPoli);
        NmPoli.setBounds(160, 100, 165, 23);

        BtnPoli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPoli.setMnemonic('X');
        BtnPoli.setText("Cari Poli");
        ...
        BtnPoli.setBounds(330, 100, 100, 23);

        jLabel14.setForeground(new java.awt.Color(0, 51, 255));
        jLabel14.setText("Tanggal Kontrol :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(580, 70, 120, 23);

        TanggalKontrol.setForeground(new java.awt.Color(50, 70, 50));
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-03-2023" }));
        ...
        TanggalKontrol.setBounds(700, 70, 95, 23);
        ...
        NmPasien.setBounds(197, 40, 300, 23);
        ...
        TglLahir.setBounds(580, 40, 95, 23);

        jLabel13.setText("Tgl.Lahir :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(510, 40, 62, 23);

        jLabel16.setText("J.K. :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(670, 40, 40, 23);

        JK.setEditable(false);
        JK.setHighlighter(null);
        JK.setName("JK"); // NOI18N
        FormInput.add(JK);
        JK.setBounds(710, 40, 95, 23);

        jLabel17.setText("Diagnosa :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(510, 10, 65, 23);

        Diagnosa.setEditable(false);
        Diagnosa.setHighlighter(null);
        Diagnosa.setName("Diagnosa"); // NOI18N
        FormInput.add(Diagnosa);
        Diagnosa.setBounds(580, 10, 310, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void NmPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NmPoliActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmPoliActionPerformed
