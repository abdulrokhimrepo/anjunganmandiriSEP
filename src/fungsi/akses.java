...
public final class akses {
    ...
    private static boolean aktif = false, admin = false, user = false, vakum = false, aplikasi = false, penyakit = false, obat_penyakit = false, dokter = false, jadwal_praktek = false, petugas = false, pasien = false, registrasi = false,
            ...
            akun_host_to_host_bank_jabar = false, pembayaran_bank_jabar = false, surat_pernyataan_pasien_umum = false, konseling_farmasi = false, koordinator_mutu = false, laporanmutu = false, checklist_pre_operasi = false, edukasi_pasien = false, mutasilangsung_farmasi = false,
            skrining_mpp = false, eval_mpp = false,
            pelayanan_informasi_obat = false,
            jawaban_pio_apoteker = false,
            surat_persetujuan_umum = false,
            transfer_pasien_antar_ruang = false,
            satu_sehat_referensi_dokter = false,
            satu_sehat_referensi_pasien = false,
            satu_sehat_mapping_departemen = false,
            satu_sehat_mapping_lokasi = false,
            satu_sehat_kirim_encounter = false,
            catatan_cek_gds = false,
            satu_sehat_kirim_condition = false,
            satu_sehat_kirim_observationttv = false,
            signin_sebelum_anestesi = false,
            satu_sehat_kirim_procedure = false,
            operasi_per_bulan = false,
            timeout_sebelum_insisi = false,
            signout_sebelum_menutup_luka = false,
            dapur_barang = false,
            dapur_opname = false,
            satu_sehat_mapping_vaksin = false,
            dapur_suplier = false,
            satu_sehat_kirim_Immunization = false,
            checklist_post_operasi = false,
            dapur_pembelian = false,
            dapur_stok_keluar = false,
            dapur_riwayat_barang = false,
            permintaan_dapur = false,
            rekonsiliasi_obat = false,
            biaya_pengadaan_dapur = false,
            rekap_pengadaan_dapur = false,
            kesling_limbah_b3medis_cair = false,
            manrisk_master = false,
            manrisk_laporan = false,
            manrisk_rekap = false;
        ...
        try {
            ...
            try {
                ...
                if (rs.getRow() >= 1) {
                    ...
                    akses.koordinator_mutu = true;
                    akses.laporanmutu = true;
                    ...
                    akses.edukasi_pasien = true;
                    akses.mutasilangsung_farmasi = true;
                    akses.skrining_mpp = true;
                    akses.eval_mpp = true;
                    ...
                    akses.manrisk_master = true;
                    akses.manrisk_laporan = true;
                    akses.manrisk_rekap = true;
                    ...
                    akses.koordinator_mutu = rs2.getBoolean("koordinator_mutu");
                    akses.checklist_pre_operasi = rs2.getBoolean("checklist_pre_operasi");
                    akses.laporanmutu = rs2.getBoolean("laporanmutu");
                    akses.edukasi_pasien = rs2.getBoolean("edukasi_pasien");
                    akses.mutasilangsung_farmasi = rs2.getBoolean("mutasilangsung_farmasi");
                    akses.skrining_mpp = rs2.getBoolean("skrining_mpp");
                    akses.eval_mpp = rs2.getBoolean("eval_mpp");
                    ...
                    akses.manrisk_master = rs2.getBoolean("manrisk_master");
                    akses.manrisk_laporan = rs2.getBoolean("manrisk_laporan");
                    akses.manrisk_rekap = rs2.getBoolean("manrisk_rekap");
                    ...
                    akses.koordinator_mutu = false;
                    akses.laporanmutu = false;
                    akses.checklist_pre_operasi = false;
                    akses.edukasi_pasien = false;
                    akses.mutasilangsung_farmasi = false;
                    akses.skrining_mpp = false;
                    akses.eval_mpp = false;
                    ...
                    akses.manrisk_master = false;
                    akses.manrisk_laporan = false;
                    akses.manrisk_rekap = false;
                }
            } catch (Exception e) {
    ...
    public static void setalamatip(String alamatip) {
        akses.alamatip = alamatip;
    }

    public static String getalamatip() {
        return akses.alamatip;
    }
    ...
    public static void setperiksalabpafalse() {
        akses.pemeriksaan_lab_pa = false;
    }
    ...
    public static boolean getset_tarif_online() {
        return akses.set_tarif_online;
    }
    ...
    public static boolean gethemodialisa() {
        return akses.hemodialisa;
    }

    public static boolean getgrafik_harian_hemodialisa() {
        return akses.grafik_harian_hemodialisa;
    }

    public static boolean getgrafik_bulanan_hemodialisa() {
        return akses.grafik_bulanan_hemodialisa;
    }

    public static boolean getgrafik_tahunan_hemodialisa() {
        return akses.grafik_tahunan_hemodialisa;
    }

    public static boolean getgrafik_bulanan_meninggal() {
        return akses.grafik_bulanan_meninggal;
    }

    public static boolean getlaporan_tahunan_irj() {
        return akses.laporan_tahunan_irj;
    }

    public static boolean getperbaikan_inventaris() {
        return akses.perbaikan_inventaris;
    }

    public static boolean getsurat_cuti_hamil() {
        return akses.surat_cuti_hamil;
    }

    public static boolean getpermintaan_stok_obat_pasien() {
        return akses.permintaan_stok_obat_pasien;
    }

    public static boolean getpemeliharaan_inventaris() {
        return akses.pemeliharaan_inventaris;
    }

    public static boolean getklasifikasi_pasien_ranap() {
        return akses.klasifikasi_pasien_ranap;
    }

    public static boolean getbulanan_klasifikasi_pasien_ranap() {
        return akses.bulanan_klasifikasi_pasien_ranap;
    }

    public static boolean getharian_klasifikasi_pasien_ranap() {
        return akses.harian_klasifikasi_pasien_ranap;
    }

    public static boolean getklasifikasi_pasien_perbangsal() {
        return akses.klasifikasi_pasien_perbangsal;
    }

    public static boolean getsoap_perawatan() {
        return akses.soap_perawatan;
    }

    public static boolean getklaim_rawat_jalan() {
        return akses.klaim_rawat_jalan;
    }

    public static boolean getskrining_gizi() {
        return akses.skrining_gizi;
    }

    public static boolean getlama_penyiapan_rm() {
        return akses.lama_penyiapan_rm;
    }

    public static boolean getdosis_radiologi() {
        return akses.dosis_radiologi;
    }

    public static boolean getdemografi_umur_kunjungan() {
        return akses.demografi_umur_kunjungan;
    }

    public static boolean getjam_diet_pasien() {
        return akses.jam_diet_pasien;
    }
    ...
    public static boolean getverifikasi_penerimaan_farmasi() {
        return akses.verifikasi_penerimaan_farmasi;
    }

    public static boolean getverifikasi_penerimaan_logistik() {
        return akses.verifikasi_penerimaan_logistik;
    }

    public static boolean getpemeriksaan_lab_pa() {
        return akses.pemeriksaan_lab_pa;
    }

    public static boolean getringkasan_pengajuan_obat() {
        return akses.ringkasan_pengajuan_obat;
    }

    public static boolean getringkasan_pemesanan_obat() {
        return akses.ringkasan_pemesanan_obat;
    }

    public static boolean getringkasan_pengadaan_obat() {
        return akses.ringkasan_pengadaan_obat;
    }

    public static boolean getringkasan_penerimaan_obat() {
        return akses.ringkasan_penerimaan_obat;
    }

    public static boolean getringkasan_hibah_obat() {
        return akses.ringkasan_hibah_obat;
    }

    public static boolean getringkasan_penjualan_obat() {
        return akses.ringkasan_penjualan_obat;
    }

    public static boolean getringkasan_beri_obat() {
        return akses.ringkasan_beri_obat;
    }

    public static boolean getringkasan_piutang_obat() {
        return akses.ringkasan_piutang_obat;
    }

    public static boolean getringkasan_stok_keluar_obat() {
        return akses.ringkasan_stok_keluar_obat;
    }

    public static boolean getringkasan_retur_suplier_obat() {
        return akses.ringkasan_retur_suplier_obat;
    }

    public static boolean getringkasan_retur_pembeli_obat() {
        return akses.ringkasan_retur_pembeli_obat;
    }

    public static boolean getpenilaian_awal_keperawatan_ranapkebidanan() {
        return akses.penilaian_awal_keperawatan_ranapkebidanan;
    }

    public static boolean getringkasan_pengajuan_nonmedis() {
        return akses.ringkasan_pengajuan_nonmedis;
    }

    public static boolean getringkasan_pemesanan_nonmedis() {
        return akses.ringkasan_pemesanan_nonmedis;
    }

    public static boolean getringkasan_pengadaan_nonmedis() {
        return akses.ringkasan_pengadaan_nonmedis;
    }

    public static boolean getringkasan_penerimaan_nonmedis() {
        return akses.ringkasan_penerimaan_nonmedis;
    }

    public static boolean getringkasan_stokkeluar_nonmedis() {
        return akses.ringkasan_stokkeluar_nonmedis;
    }

    public static boolean getringkasan_returbeli_nonmedis() {
        return akses.ringkasan_returbeli_nonmedis;
    }

    public static boolean getomset_penerimaan() {
        return akses.omset_penerimaan;
    }

    public static boolean getvalidasi_penagihan_piutang() {
        return akses.validasi_penagihan_piutang;
    }

    public static boolean getpermintaan_ranap() {
        return akses.permintaan_ranap;
    }

    public static boolean getbpjs_diagnosa_prb() {
        return akses.bpjs_diagnosa_prb;
    }

    public static boolean getbpjs_obat_prb() {
        return akses.bpjs_obat_prb;
    }

    public static boolean getbpjs_surat_kontrol() {
        return akses.bpjs_surat_kontrol;
    }

    public static boolean getpenggunaan_bhp_ok() {
        return akses.penggunaan_bhp_ok;
    }

    public static boolean getsurat_keterangan_rawat_inap() {
        return akses.surat_keterangan_rawat_inap;
    }

    public static boolean getsurat_keterangan_sehat() {
        return akses.surat_keterangan_sehat;
    }

    public static boolean getpendapatan_per_carabayar() {
        return akses.pendapatan_per_carabayar;
    }

    public static boolean getakun_host_to_host_bank_jateng() {
        return akses.akun_host_to_host_bank_jateng;
    }

    public static boolean getpembayaran_bank_jateng() {
        return akses.pembayaran_bank_jateng;
    }

    public static boolean getbpjs_surat_pri() {
        return akses.bpjs_surat_pri;
    }

    public static boolean getringkasan_tindakan() {
        return akses.ringkasan_tindakan;
    }

    public static boolean getlama_pelayanan_pasien() {
        return akses.lama_pelayanan_pasien;
    }

    public static boolean getsurat_sakit_pihak_2() {
        return akses.surat_sakit_pihak_2;
    }

    public static boolean gettagihan_hutang_obat() {
        return akses.tagihan_hutang_obat;
    }

    public static boolean getreferensi_mobilejkn_bpjs() {
        return akses.referensi_mobilejkn_bpjs;
    }

    public static boolean getbatal_pendaftaran_mobilejkn_bpjs() {
        return akses.batal_pendaftaran_mobilejkn_bpjs;
    }

    public static boolean getlama_operasi() {
        return akses.lama_operasi;
    }

    public static boolean getgrafik_inventaris_kategori() {
        return akses.grafik_inventaris_kategori;
    }

    public static boolean getgrafik_inventaris_merk() {
        return akses.grafik_inventaris_merk;
    }

    public static boolean getgrafik_inventaris_produsen() {
        return akses.grafik_inventaris_produsen;
    }

    public static boolean getpengembalian_deposit_pasien() {
        return akses.pengembalian_deposit_pasien;
    }

    public static boolean getvalidasi_tagihan_hutang_obat() {
        return akses.validasi_tagihan_hutang_obat;
    }

    public static boolean getpiutang_obat_belum_lunas() {
        return akses.piutang_obat_belum_lunas;
    }

    public static boolean getintegrasi_briapi() {
        return akses.integrasi_briapi;
    }

    public static boolean getpengadaan_aset_inventaris() {
        return akses.pengadaan_aset_inventaris;
    }

    public static boolean getakun_aset_inventaris() {
        return akses.akun_aset_inventaris;
    }

    public static boolean getsuplier_inventaris() {
        return akses.suplier_inventaris;
    }

    public static boolean getpenerimaan_aset_inventaris() {
        return akses.penerimaan_aset_inventaris;
    }

    public static boolean getbayar_pemesanan_iventaris() {
        return akses.bayar_pemesanan_iventaris;
    }

    public static boolean gethutang_aset_inventaris() {
        return akses.hutang_aset_inventaris;
    }

    public static boolean gethibah_aset_inventaris() {
        return akses.hibah_aset_inventaris;
    }

    public static boolean gettitip_faktur_non_medis() {
        return akses.titip_faktur_non_medis;
    }

    public static boolean getvalidasi_tagihan_non_medis() {
        return akses.validasi_tagihan_non_medis;
    }

    public static boolean gettitip_faktur_aset() {
        return akses.titip_faktur_aset;
    }

    public static boolean getvalidasi_tagihan_aset() {
        return akses.validasi_tagihan_aset;
    }

    public static boolean gethibah_non_medis() {
        return akses.hibah_non_medis;
    }

    public static boolean getpcare_alasan_tacc() {
        return akses.pcare_alasan_tacc;
    }

    public static boolean getresep_luar() {
        return akses.resep_luar;
    }

    public static boolean getsurat_bebas_tbc() {
        return akses.surat_bebas_tbc;
    }

    public static boolean getsurat_buta_warna() {
        return akses.surat_buta_warna;
    }

    public static boolean getsurat_bebas_tato() {
        return akses.surat_bebas_tato;
    }

    public static boolean getsurat_kewaspadaan_kesehatan() {
        return akses.surat_kewaspadaan_kesehatan;
    }

    public static boolean getgrafik_porsidiet_pertanggal() {
        return akses.grafik_porsidiet_pertanggal;
    }

    public static boolean getgrafik_porsidiet_perbulan() {
        return akses.grafik_porsidiet_perbulan;
    }

    public static boolean getgrafik_porsidiet_pertahun() {
        return akses.grafik_porsidiet_pertahun;
    }

    public static boolean getgrafik_porsidiet_perbangsal() {
        return akses.grafik_porsidiet_perbangsal;
    }

    public static boolean getpenilaian_awal_medis_ralan() {
        return akses.penilaian_awal_medis_ralan;
    }

    public static boolean getmaster_masalah_keperawatan_mata() {
        return akses.master_masalah_keperawatan_mata;
    }

    public static boolean getpenilaian_awal_keperawatan_mata() {
        return akses.penilaian_awal_keperawatan_mata;
    }

    public static boolean getpenilaian_awal_medis_ranap() {
        return akses.penilaian_awal_medis_ranap;
    }

    public static boolean getpenilaian_awal_medis_ranap_kebidanan() {
        return akses.penilaian_awal_medis_ranap_kebidanan;
    }

    public static boolean getpenilaian_awal_medis_ralan_kebidanan() {
        return akses.penilaian_awal_medis_ralan_kebidanan;
    }

    public static boolean getpenilaian_awal_medis_igd() {
        return akses.penilaian_awal_medis_igd;
    }

    public static boolean getpenilaian_awal_medis_ralan_anak() {
        return akses.penilaian_awal_medis_ralan_anak;
    }

    public static boolean getbpjs_referensi_poli_hfis() {
        return akses.bpjs_referensi_poli_hfis;
    }

    public static boolean getbpjs_referensi_dokter_hfis() {
        return akses.bpjs_referensi_dokter_hfis;
    }

    public static boolean getbpjs_referensi_jadwal_hfis() {
        return akses.bpjs_referensi_jadwal_hfis;
    }

    public static boolean getpenilaian_fisioterapi() {
        return akses.penilaian_fisioterapi;
    }

    public static boolean getbpjs_program_prb() {
        return akses.bpjs_program_prb;
    }

    public static boolean getbpjs_suplesi_jasaraharja() {
        return akses.bpjs_suplesi_jasaraharja;
    }

    public static boolean getbpjs_data_induk_kecelakaan() {
        return akses.bpjs_data_induk_kecelakaan;
    }

    public static boolean getbpjs_sep_internal() {
        return akses.bpjs_sep_internal;
    }

    public static boolean getbpjs_klaim_jasa_raharja() {
        return akses.bpjs_klaim_jasa_raharja;
    }

    public static boolean getbpjs_daftar_finger_print() {
        return akses.bpjs_daftar_finger_print;
    }

    public static boolean getbpjs_rujukan_khusus() {
        return akses.bpjs_rujukan_khusus;
    }

    public static boolean getpemeliharaan_gedung() {
        return akses.pemeliharaan_gedung;
    }

    public static boolean getgrafik_perbaikan_inventaris_pertanggal() {
        return akses.grafik_perbaikan_inventaris_pertanggal;
    }

    public static boolean getgrafik_perbaikan_inventaris_perbulan() {
        return akses.grafik_perbaikan_inventaris_perbulan;
    }

    public static boolean getgrafik_perbaikan_inventaris_pertahun() {
        return akses.grafik_perbaikan_inventaris_pertahun;
    }

    public static boolean getgrafik_perbaikan_inventaris_perpelaksana_status() {
        return akses.grafik_perbaikan_inventaris_perpelaksana_status;
    }

    public static boolean getpenilaian_mcu() {
        return akses.penilaian_mcu;
    }

    public static boolean getpeminjam_piutang() {
        return akses.peminjam_piutang;
    }

    public static boolean getpiutang_lainlain() {
        return akses.piutang_lainlain;
    }

    public static boolean getcara_bayar() {
        return akses.cara_bayar;
    }

    public static boolean getaudit_kepatuhan_apd() {
        return akses.audit_kepatuhan_apd;
    }

    public static boolean getbpjs_task_id() {
        return akses.bpjs_task_id;
    }

    public static boolean getbayar_piutang_lain() {
        return akses.bayar_piutang_lain;
    }

    public static boolean getpembayaran_akun_bayar4() {
        return akses.pembayaran_akun_bayar4;
    }

    public static boolean getstok_akhir_farmasi_pertanggal() {
        return akses.stok_akhir_farmasi_pertanggal;
    }

    public static boolean getriwayat_kamar_pasien() {
        return akses.riwayat_kamar_pasien;
    }

    public static boolean getuji_fungsi_kfr() {
        return akses.uji_fungsi_kfr;
    }

    public static boolean gethapus_berkas_digital_perawatan() {
        return akses.hapus_berkas_digital_perawatan;
    }

    public static boolean getkategori_pengeluaran_harian() {
        return akses.kategori_pengeluaran_harian;
    }

    public static boolean getkategori_pemasukan_lain() {
        return akses.kategori_pemasukan_lain;
    }

    public static boolean getpembayaran_akun_bayar5() {
        return akses.pembayaran_akun_bayar5;
    }

    public static boolean getruang_ok() {
        return akses.ruang_ok;
    }

    public static boolean getjasa_tindakan_pasien() {
        return akses.jasa_tindakan_pasien;
    }

    public static boolean gettelaah_resep() {
        return akses.telaah_resep;
    }

    public static boolean getpermintaan_resep_pulang() {
        return akses.permintaan_resep_pulang;
    }

    public static boolean getrekap_jm_dokter() {
        return akses.rekap_jm_dokter;
    }

    public static boolean getstatus_data_rm() {
        return akses.status_data_rm;
    }

    public static boolean getubah_petugas_lab_pk() {
        return akses.ubah_petugas_lab_pk;
    }

    public static boolean getubah_petugas_lab_pa() {
        return akses.ubah_petugas_lab_pa;
    }

    public static boolean getubah_petugas_radiologi() {
        return akses.ubah_petugas_radiologi;
    }

    public static boolean getgabung_norawat() {
        return akses.gabung_norawat;
    }

    public static boolean getgabung_rm() {
        return akses.gabung_rm;
    }

    public static boolean getringkasan_biaya_obat_pasien_pertanggal() {
        return akses.ringkasan_biaya_obat_pasien_pertanggal;
    }

    public static boolean getmaster_masalah_keperawatan_igd() {
        return akses.master_masalah_keperawatan_igd;
    }

    public static boolean getpenilaian_awal_keperawatan_igd() {
        return akses.penilaian_awal_keperawatan_igd;
    }

    public static boolean getbpjs_referensi_dpho_apotek() {
        return akses.bpjs_referensi_dpho_apotek;
    }

    public static boolean getbpjs_referensi_poli_apotek() {
        return akses.bpjs_referensi_poli_apotek;
    }

    public static boolean getbayar_jm_dokter() {
        return akses.bayar_jm_dokter;
    }

    public static boolean getbpjs_referensi_faskes_apotek() {
        return akses.bpjs_referensi_faskes_apotek;
    }

    public static boolean getbpjs_referensi_spesialistik_apotek() {
        return akses.bpjs_referensi_spesialistik_apotek;
    }

    public static boolean getpembayaran_briva() {
        return akses.pembayaran_briva;
    }

    public static boolean getpenilaian_awal_keperawatan_ranap() {
        return akses.penilaian_awal_keperawatan_ranap;
    }

    public static boolean getnilai_penerimaan_vendor_farmasi_perbulan() {
        return akses.nilai_penerimaan_vendor_farmasi_perbulan;
    }

    public static boolean getakun_bayar_hutang() {
        return akses.akun_bayar_hutang;
    }

    public static boolean getmaster_rencana_keperawatan() {
        return akses.master_rencana_keperawatan;
    }

    public static boolean getlaporan_tahunan_igd() {
        return akses.laporan_tahunan_igd;
    }

    public static boolean getobat_bhp_tidakbergerak() {
        return akses.obat_bhp_tidakbergerak;
    }

    public static boolean getringkasan_hutang_vendor_farmasi() {
        return akses.ringkasan_hutang_vendor_farmasi;
    }

    public static boolean getnilai_penerimaan_vendor_nonmedis_perbulan() {
        return akses.nilai_penerimaan_vendor_nonmedis_perbulan;
    }

    public static boolean getringkasan_hutang_vendor_nonmedis() {
        return akses.ringkasan_hutang_vendor_nonmedis;
    }

    public static boolean getanggota_polri_dirawat() {
        return akses.anggota_polri_dirawat;
    }

    public static boolean getdaftar_pasien_ranap_polri() {
        return akses.daftar_pasien_ranap_polri;
    }

    public static boolean getsoap_ralan_polri() {
        return akses.soap_ralan_polri;
    }

    public static boolean getsoap_ranap_polri() {
        return akses.soap_ranap_polri;
    }

    public static boolean getlaporan_penyakit_polri() {
        return akses.laporan_penyakit_polri;
    }

    public static boolean getmaster_rencana_keperawatan_anak() {
        return akses.master_rencana_keperawatan_anak;
    }

    public static boolean getjumlah_pengunjung_ralan_polri() {
        return akses.jumlah_pengunjung_ralan_polri;
    }

    public static boolean getcatatan_observasi_igd() {
        return akses.catatan_observasi_igd;
    }

    public static boolean getcatatan_observasi_ranap() {
        return akses.catatan_observasi_ranap;
    }

    public static boolean getcatatan_observasi_ranap_kebidanan() {
        return akses.catatan_observasi_ranap_kebidanan;
    }

    public static boolean getcatatan_observasi_ranap_postpartum() {
        return akses.catatan_observasi_ranap_postpartum;
    }

    public static boolean getpenilaian_awal_medis_ralan_tht() {
        return akses.penilaian_awal_medis_ralan_tht;
    }

    public static boolean getpenilaian_psikologi() {
        return akses.penilaian_psikologi;
    }

    public static boolean getaudit_cuci_tangan_medis() {
        return akses.audit_cuci_tangan_medis;
    }

    public static boolean getaudit_pembuangan_limbah() {
        return akses.audit_pembuangan_limbah;
    }

    public static boolean getruang_audit_kepatuhan() {
        return akses.ruang_audit_kepatuhan;
    }

    public static boolean getaudit_pembuangan_benda_tajam() {
        return akses.audit_pembuangan_benda_tajam;
    }

    public static boolean getaudit_penanganan_darah() {
        return akses.audit_penanganan_darah;
    }

    public static boolean getaudit_pengelolaan_linen_kotor() {
        return akses.audit_pengelolaan_linen_kotor;
    }

    public static boolean getaudit_penempatan_pasien() {
        return akses.audit_penempatan_pasien;
    }

    public static boolean getaudit_kamar_jenazah() {
        return akses.audit_kamar_jenazah;
    }

    public static boolean getaudit_bundle_iadp() {
        return akses.audit_bundle_iadp;
    }

    public static boolean getaudit_bundle_ido() {
        return akses.audit_bundle_ido;
    }

    public static boolean getaudit_fasilitas_kebersihan_tangan() {
        return akses.audit_fasilitas_kebersihan_tangan;
    }

    public static boolean getaudit_fasilitas_apd() {
        return akses.audit_fasilitas_apd;
    }

    public static boolean getaudit_pembuangan_limbah_cair_infeksius() {
        return akses.audit_pembuangan_limbah_cair_infeksius;
    }

    public static boolean getaudit_sterilisasi_alat() {
        return akses.audit_sterilisasi_alat;
    }

    public static boolean getpenilaian_awal_medis_ralan_psikiatri() {
        return akses.penilaian_awal_medis_ralan_psikiatri;
    }

    public static boolean getpersetujuan_penolakan_tindakan() {
        return akses.persetujuan_penolakan_tindakan;
    }

    public static boolean getaudit_bundle_isk() {
        return akses.audit_bundle_isk;
    }

    public static boolean getaudit_bundle_plabsi() {
        return akses.audit_bundle_plabsi;
    }

    public static boolean getaudit_bundle_vap() {
        return akses.audit_bundle_vap;
    }

    public static boolean getakun_host_to_host_bank_papua() {
        return akses.akun_host_to_host_bank_papua;
    }

    public static boolean getpembayaran_bank_papua() {
        return akses.pembayaran_bank_papua;
    }

    public static boolean getpenilaian_awal_medis_ralan_penyakit_dalam() {
        return akses.penilaian_awal_medis_ralan_penyakit_dalam;
    }

    public static boolean getpenilaian_awal_medis_ralan_mata() {
        return akses.penilaian_awal_medis_ralan_mata;
    }

    public static boolean getpenilaian_awal_medis_ralan_neurologi() {
        return akses.penilaian_awal_medis_ralan_neurologi;
    }

    public static boolean getsirkulasi_obat6() {
        return akses.sirkulasi_obat6;
    }

    public static boolean getpenilaian_awal_medis_ralan_orthopedi() {
        return akses.penilaian_awal_medis_ralan_orthopedi;
    }

    public static boolean getpenilaian_awal_medis_ralan_bedah() {
        return akses.penilaian_awal_medis_ralan_bedah;
    }

    public static boolean getintegrasi_khanza_health_services() {
        return akses.integrasi_khanza_health_services;
    }

    public static boolean getsoap_ralan_tni() {
        return akses.soap_ralan_tni;
    }

    public static boolean getsoap_ranap_tni() {
        return akses.soap_ranap_tni;
    }

    public static boolean getjumlah_pengunjung_ralan_tni() {
        return akses.jumlah_pengunjung_ralan_tni;
    }

    public static boolean getlaporan_penyakit_tni() {
        return akses.laporan_penyakit_tni;
    }

    public static boolean getcatatan_keperawatan_ranap() {
        return akses.catatan_keperawatan_ranap;
    }

    public static boolean getmaster_rencana_keperawatan_gigi() {
        return akses.master_rencana_keperawatan_gigi;
    }

    public static boolean getmaster_rencana_keperawatan_mata() {
        return akses.master_rencana_keperawatan_mata;
    }

    public static boolean getmaster_rencana_keperawatan_igd() {
        return akses.master_rencana_keperawatan_igd;
    }

    public static boolean getmaster_masalah_keperawatan_psikiatri() {
        return akses.master_masalah_keperawatan_psikiatri;
    }

    public static boolean getmaster_rencana_keperawatan_psikiatri() {
        return akses.master_rencana_keperawatan_psikiatri;
    }

    public static boolean getpenilaian_awal_keperawatan_psikiatri() {
        return akses.penilaian_awal_keperawatan_psikiatri;
    }

    public static boolean getpemantauan_pews_anak() {
        return akses.pemantauan_pews_anak;
    }

    public static boolean getsurat_pulang_atas_permintaan_sendiri() {
        return akses.surat_pulang_atas_permintaan_sendiri;
    }

    public static boolean gettemplate_hasil_radiologi() {
        return akses.template_hasil_radiologi;
    }

    public static boolean getlaporan_bulanan_irj() {
        return akses.laporan_bulanan_irj;
    }

    public static boolean gettemplate_pemeriksaan() {
        return akses.template_pemeriksaan;
    }

    public static boolean getpemeriksaan_lab_mb() {
        return akses.pemeriksaan_lab_mb;
    }

    public static boolean getubah_petugas_lab_mb() {
        return akses.ubah_petugas_lab_mb;
    }

    public static boolean getpenilaian_pre_operasi() {
        return akses.penilaian_pre_operasi;
    }

    public static boolean getpenilaian_pre_anestesi() {
        return akses.penilaian_pre_anestesi;
    }

    public static boolean getperencanaan_pemulangan() {
        return akses.perencanaan_pemulangan;
    }

    public static boolean getpenilaian_lanjutan_resiko_jatuh_dewasa() {
        return akses.penilaian_lanjutan_resiko_jatuh_dewasa;
    }

    public static boolean getpenilaian_lanjutan_resiko_jatuh_anak() {
        return akses.penilaian_lanjutan_resiko_jatuh_anak;
    }

    public static boolean getpenilaian_awal_medis_ralan_geriatri() {
        return akses.penilaian_awal_medis_ralan_geriatri;
    }

    public static boolean getpenilaian_tambahan_pasien_geriatri() {
        return akses.penilaian_tambahan_pasien_geriatri;
    }

    public static boolean getskrining_nutrisi_dewasa() {
        return akses.skrining_nutrisi_dewasa;
    }

    public static boolean getskrining_nutrisi_lansia() {
        return akses.skrining_nutrisi_lansia;
    }

    public static boolean gethasil_pemeriksaan_usg() {
        return akses.hasil_pemeriksaan_usg;
    }

    public static boolean getskrining_nutrisi_anak() {
        return akses.skrining_nutrisi_anak;
    }

    public static boolean getakun_host_to_host_bank_jabar() {
        return akses.akun_host_to_host_bank_jabar;
    }

    public static boolean getpembayaran_bank_jabar() {
        return akses.pembayaran_bank_jabar;
    }

    public static boolean getsurat_pernyataan_pasien_umum() {
        return akses.surat_pernyataan_pasien_umum;
    }

    public static boolean getkonseling_farmasi() {
        return akses.konseling_farmasi;
    }

    public static boolean getkoordinator_mutu() {
        return akses.koordinator_mutu;
    }

    public static boolean getlaporanmutu() {
        return akses.laporanmutu;
    }

    public static boolean getchecklist_preoperasi() {
        return akses.checklist_pre_operasi;
    }

    public static boolean getedukasi_pasien() {
        return akses.edukasi_pasien;
    }

    public static boolean getmutasilangsung_farmasi() {
        return akses.mutasilangsung_farmasi;
    }

    public static boolean getskrining_mpp() {
        return akses.skrining_mpp;
    }

    public static boolean geteval_mpp() {
        return akses.eval_mpp;
    }

    public static boolean getpelayanan_informasi_obat() {
        return akses.pelayanan_informasi_obat;
    }

    public static boolean getjawaban_pio_apoteker() {
        return akses.jawaban_pio_apoteker;
    }

    public static boolean getsurat_persetujuan_umum() {
        return akses.surat_persetujuan_umum;
    }

    public static boolean gettransfer_pasien_antar_ruang() {
        return akses.transfer_pasien_antar_ruang;
    }

    public static boolean getsatu_sehat_referensi_dokter() {
        return akses.satu_sehat_referensi_dokter;
    }

    public static boolean getsatu_sehat_referensi_pasien() {
        return akses.satu_sehat_referensi_pasien;
    }

    public static boolean getsatu_sehat_mapping_departemen() {
        return akses.satu_sehat_mapping_departemen;
    }

    public static boolean getsatu_sehat_mapping_lokasi() {
        return akses.satu_sehat_mapping_lokasi;
    }

    public static boolean getsatu_sehat_kirim_encounter() {
        return akses.satu_sehat_kirim_encounter;
    }

    public static boolean getcatatan_cek_gds() {
        return akses.catatan_cek_gds;
    }

    public static boolean getsatu_sehat_kirim_condition() {
        return akses.satu_sehat_kirim_condition;
    }

    public static boolean getsatu_sehat_kirim_observationttv() {
        return akses.satu_sehat_kirim_observationttv;
    }

    public static boolean getsignin_sebelum_anestesi() {
        return akses.signin_sebelum_anestesi;
    }

    public static boolean getsatu_sehat_kirim_procedure() {
        return akses.satu_sehat_kirim_procedure;
    }

    public static boolean getoperasi_per_bulan() {
        return akses.operasi_per_bulan;
    }

    public static boolean gettimeout_sebelum_insisi() {
        return akses.timeout_sebelum_insisi;
    }

    public static boolean getsignout_sebelum_menutup_luka() {
        return akses.signout_sebelum_menutup_luka;
    }

    public static boolean getdapur_barang() {
        return akses.dapur_barang;
    }

    public static boolean getdapur_opname() {
        return akses.dapur_opname;
    }

    public static boolean getsatu_sehat_mapping_vaksin() {
        return akses.satu_sehat_mapping_vaksin;
    }

    public static boolean getdapur_suplier() {
        return akses.dapur_suplier;
    }

    public static boolean getsatu_sehat_kirim_Immunization() {
        return akses.satu_sehat_kirim_Immunization;
    }

    public static boolean getchecklist_post_operasi() {
        return akses.checklist_post_operasi;
    }

    public static boolean getdapur_pembelian() {
        return akses.dapur_pembelian;
    }

    public static boolean getdapur_stok_keluar() {
        return akses.dapur_stok_keluar;
    }

    public static boolean getdapur_riwayat_barang() {
        return akses.dapur_riwayat_barang;
    }

    public static boolean getpermintaan_dapur() {
        return akses.permintaan_dapur;
    }

    public static boolean getrekonsiliasi_obat() {
        return akses.rekonsiliasi_obat;
    }

    public static boolean getbiaya_pengadaan_dapur() {
        return akses.biaya_pengadaan_dapur;
    }

    public static boolean getrekap_pengadaan_dapur() {
        return akses.rekap_pengadaan_dapur;
    }

    public static boolean getkesling_limbah_b3medis_cair() {
        return akses.kesling_limbah_b3medis_cair;
    }

    public static boolean getmanrisk_master() {
        return akses.manrisk_master;
    }

    public static boolean getmanrisk_laporan() {
        return akses.manrisk_laporan;
    }

    public static boolean getmanrisk_rekap() {
        return akses.manrisk_rekap;
    }
}
